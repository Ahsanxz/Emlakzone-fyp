...
class PlotVC: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func DataLoader()
        {
            ...
            let networking = Networking(baseURL: "http://server.emlakzone.com/public/api/v1/search")
                networking.get("/properties?propertyTypeId=2&size=10&offset=" + "\(offsetSize)") { result in
                   switch result {
...
extension PlotVC: UICollectionViewDelegateFlowLayout{
